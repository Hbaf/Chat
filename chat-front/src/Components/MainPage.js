        ...
        return(
            <div className='main'>
                <div className='description'>
                    <h1>
                        Hello there. Welcome to our chat!
                    </h1>
                    <p>
                        We offer you
                    </p>
                ...
                <svg id="41468acd-cd3b-42a6-b6d6-962a1482835f" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="869" height="634.74" viewBox="0 0 869 634.74">
                    <defs>
                        ...
                        <linearGradient id="81ddbcf2-2292-4b47-939f-09c11d0fad8e" x1="436.09" y1="608.57" x2="436.09" y2="132.63" xlinkHref="#1bb150a8-47e8-48a0-8586-3a0b005e9061"/>
                    </defs>
                    <title>chat</title>
                    ...
                    <rect x="162.16" y="66.61" width="216.47" height="27.06" fill="#008b8b"/>
                    <rect x="163.39" y="116.56" width="81.18" height="27.06" fill="#008b8b"/>
                    <rect x="164.62" y="166.51" width="160.08" height="27.06" fill="#008b8b"/>
                <rect x="165.85" y="216.47" width="196.32" height="27.06" fill="#008b8b"/>
                <rect x="167.08" y="266.42" width="103.51" height="27.06" fill="#008b8b"/></svg>
            </div>
        )
    }
}
